<?php
    ...
    include 'init.php';
?>
<link rel = "stylesheet" href = "<?php echo $css ?>back3.css"/>

    <section class="MYACOUNT">
    <div class="h3"><h3 class="tittle">  My Contact </h3></div>
    <div class="contact-map inner-sec"></div>
    <div class="CUONT">
        <div class="container">
